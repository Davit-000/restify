...
var Fields = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Fields, [{
    ...
    value: function only(fields) {
      return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["pick"])(this.all, fields);
    }
    /**
    ...
    value: function except(fields) {
      return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["omit"])(this.all, fields);
    }
    /**
...
var Form = /*#__PURE__*/function () {
  function Form(errors) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "rules", {});

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "errors", {});
...
/* harmony import */ var _Form__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Form */ "./src/Form.js");
/* harmony import */ var _Fields__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Fields */ "./src/Fields.js");
/* harmony import */ var _RequestBuilder__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./RequestBuilder */ "./src/RequestBuilder.js");
...
var Model = /*#__PURE__*/function (_Form) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(Model, _Form);
  ...
  function Model() {
    ...
    _builder.set(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this), {
      writable: true,
      value: void 0
    });

    _state.set(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this), {
      writable: true,
      value: {}
    });

    _events.set(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this), {
      writable: true,
      value: {}
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this), "fields", {});
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this), "origin", window.location.origin);
    ...
    _this.fields = new _Fields__WEBPACK_IMPORTED_MODULE_12__["Fields"](fields);

    _babel_runtime_helpers_classPrivateFieldSet__WEBPACK_IMPORTED_MODULE_8___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this), _builder, new _RequestBuilder__WEBPACK_IMPORTED_MODULE_13__["RequestBuilder"](_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this), {
      url: _this.uri,
      baseURL: _this.origin
    }));

    Object.keys(_this.fields.all).forEach(function (key) {
      Object.defineProperty(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this), key, {
        get: function get() {
          return this.fields.get(key);
        },
        set: function set(v) {
          this.fields.set(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()({}, key, v));
          this.trigger('change', {
            key: key,
            v: v
          });
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Model, [{
    ...
    value: function on(eventName, callback) {
      ...
      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_7___default()(this, _events)[eventName] = handlers;
    }
    /**
    ...
    value: function reset() {
      this.errors = {};
      this.fields.set(_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_7___default()(this, _state));
      this.trigger('reset');
    }
    /**
    ...
    value: function destroy() {
      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_7___default()(this, _builder).setMethod('delete');
    ...
    value: function restore() {
      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_7___default()(this, _builder).setMethod('put');

      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_7___default()(this, _builder).setParam(this.fields.get('id'));

      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_7___default()(this, _builder).suffix('restore');
    ...
    value: function all() {
      ...
      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_7___default()(model, _builder).setMethod('get');

      return _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_7___default()(model, _builder);
    }
    /**
     * Get single resource
     *
    ...
    value: function find(id) {
      ...
      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_7___default()(model, _builder).setParam(id);

      return _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_7___default()(model, _builder);
    }
  }, {
    key: "destroyMany",
    value: function destroyMany(ids) {
      var model = new this();

      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_7___default()(model, _builder).setMethod('get');

      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_7___default()(model, _builder).query({
        ids: ids
      });
  ...
  return Model;
}(_Form__WEBPACK_IMPORTED_MODULE_11__["Form"]);
...
var _transformToFormdata = new WeakSet();
...
var RequestBuilder = /*#__PURE__*/function () {
   ...
   */
  function RequestBuilder(model, request) {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, RequestBuilder);

    _transformToFormdata.add(this);
    ...
    _methods.set(this, {
      writable: true,
      value: ['get', 'head', 'post', 'patch', 'put', 'delete']
    });
    ...
    _babel_runtime_helpers_classPrivateFieldSet__WEBPACK_IMPORTED_MODULE_3___default()(this, _model, model);

    _babel_runtime_helpers_classPrivateFieldSet__WEBPACK_IMPORTED_MODULE_3___default()(this, _request, Object.assign({}, _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _request), request));
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(RequestBuilder, [{
    key: "setMethod",
    ...
    value: function setMethod(method) {
      if (_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _methods).includes(method)) _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _request).method = method;else throw new Error('wrong request method provided.');
    }
    /**
    ...
    key: "setParam",
    value: function setParam(id) {
      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _request).url = "".concat(_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _request).url, "/").concat(id);
    }
    /**
     * Set's request data
     *
    ...
    value: function prefix(_prefix) {
      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _request).url = "".concat(_prefix, "/").concat(_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _request).url);
      return this;
    }
    /**
    ...
    value: function suffix(_suffix) {
      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _request).url = "".concat(_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _request).url, "/").concat(_suffix);
      return this;
    }
    /**
    ...
    value: function headers(_headers) {
      Object.assign(_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _request).headers, _headers);
      return this;
    }
    /**
    ...
    value: function query(params) {
      Object.assign(_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _request).params, params);
      return this;
    }
    /**
     * Send request
    ...
    value: function send() {
      ...
      _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _model).trigger('sending');

      if (_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _model).formdata) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_5___default.a.request(_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _request)).then(function (res) {
        ...
        _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(_this, _model).trigger('failed');
    ...
    key: "origin",
    get: function get() {
      return _babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_2___default()(this, _model).origin;
    }
  }]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var _Model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Model */ "./src/Model.js");

module.exports = _Model__WEBPACK_IMPORTED_MODULE_0__["Model"];
